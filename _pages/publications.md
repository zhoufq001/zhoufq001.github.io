...
## 4. Enhancing Resilience in Local Food Systems through LLM-Based Multi-Agent Decision Support for Adaptive Coordination, with Dr. Wenbo Wang, Qin Liu, Dr. Jasmine (Aichih) Chang, Dr. Jim Shi.
<details class="publication-abstract">
<summary>Abstract</summary>
...
## 6. Integrating AI-Powered XR Wearables for Real-Time Shelf-Life Estimation and Pricing Optimization, with Dr. Jasmine (Aichih) Chang
<details class="publication-abstract">
<summary>Abstract</summary>
...
## 7. The Impact and Implications of Bag Tax Policies on Sustainable Operations: A Systems Dynamics Approach, with Dr. Nesreen El-Rayes, Dr. Jasmine (Aichih) Chang, Dr. Jim Shi
<details class="publication-abstract">
<summary>Abstract</summary>
